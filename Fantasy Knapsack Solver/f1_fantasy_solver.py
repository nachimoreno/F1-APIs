...
def main():
    ...
    parser.add_argument("--budget", type=float, default=100.0, help="Budget available for the lineup.")
    parser.add_argument("--risk_penalty", type=float, default=0.5, help="Risk penalty for the lineup. Value between 0 and 1. Higher values penalize riskier drivers more.")
    parser.add_argument("--top_n", type=int, default=3, help="Number of best lineups to return.")
    parser.add_argument("--exclude_drivers", nargs="*", default=[], help="Driver(s) to exclude from the lineup.")
    parser.add_argument("--exclude_teams", nargs="*", default=[], help="Team(s) to exclude from the lineup.")
    parser.add_argument("--verbosity", type=int, default=0, help="Enable verbose output. 0 = No output, 1 = Basic output, 2 = Detailed output.")
